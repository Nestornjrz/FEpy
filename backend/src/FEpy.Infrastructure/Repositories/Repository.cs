...
using FEpy.Infrastructure.Specification;
using System.Linq.Expressions;
using Microsoft.EntityFrameworkCore.Query;
using FEpy.Infrastructure.Extensions;

namespace FEpy.Infrastructure.Repositories;
...
where TEntityId : class
{
    ...
    #region Desde aqui todos son metodos con paginaciones utilizando el patron specification 
    ...
    #region Paginacion con metodos genericos
